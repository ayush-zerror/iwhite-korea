    ...
    return (
        <div className='w-full bg-[#FDF9EE] flex justify-between px-3 sm:px-10 py-[10vw] sm:py-[5vw]'>
            <div className='hidden sm:block w-[2.5%] relative border-r-2 border-[#E0DDD5]'>
                <h4 className='absolute rotate-90 top-[9%] left-[-150%] whitespace-nowrap uppercase font-[second] sm:font-[fourth] font-semibold text-[1vw]'>our philosophy</h4>
            </div>
            <div className='w-full sm:w-[94%] flex flex-col sm:flex-row items-start h-fit'>
                <div className='w-full sm:w-1/2'>
                    <h1 className='text-[10vw] sm:text-[4.2vw] font-[third] sm:font-[five] uppercase leading-none mb-[1vw]'>our</h1>
                    <h1 className='text-[10vw] sm:text-[4.2vw] font-[second] sm:font-[fourth] uppercase leading-none mb-[5vw] sm:mb-0'>philosophy</h1>
                </div>
                <div className='w-full sm:w-1/2 text-[#635758]'>
                    <h2 className='text-[4.2vw] sm:text-[2vw] font-[second] sm:font-[fourth]'>
                    ...
                    <h4 className='text-[4.2vw] sm:text-[1.5vw] my-[6vw] sm:my-[2vw] font-[second] sm:font-[fourth]'><span className='text-black'>Cheot-Sarang </span>
                        the feeling of experiencing your first love. A love that comes
                        from within and when simple heartwarming gestures feels
                        so grand.</h4>
                    <h4 className='text-[4.2vw] sm:text-[1.5vw] font-[second] sm:font-[fourth]'><span className='text-black'>Malg-eum </span>
