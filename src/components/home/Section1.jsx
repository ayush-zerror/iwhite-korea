  ...
  return (
    <div className='fixed top-0 left-0 w-full h-screen flex'>
      ...
      <div className='w-full h-full absolute top-0 left-0 bg-gradient-to-b from-[#0000000c] to-[#000000c2]  text-white flex flex-col items-center justify-end pb-[30vw] sm:pb-[6vw]'>
        ...
        <div className='hometxt capitalize text-white px-8 py-2  border border-white rounded-full hover:bg-zinc-800 cursor-pointer hover:border-zinc-800 relative overflow-hidden'>
          <div className='w-full h-full bg-black absolute top-full left-1/2 -translate-x-1/2 rounded-[50%]'></div>
          <h2 className='relative whitespace-nowrap'>find out more</h2>
        </div>
          </>)
        }
      </div>
