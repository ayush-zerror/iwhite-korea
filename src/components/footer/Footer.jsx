...
const Footer = () => {
    ...
    return (
        <div className='w-full min-h-[70vh] bg-[#FDF9EE] pointer-events-auto'>
            <div className='w-full h-full rounded-tl-3xl rounded-tr-3xl sm:bg-[#f0ece2] p-3 sm:p-6'>
                <div className='w-full pb-[6vw] bg-[#FDF9EE] rounded-2xl px-[3vw] pt-[9vw] sm:pt-[3vw] flex flex-col sm:flex-row items-center sm:items-start justify-between'>
                    ...
                    <div className='sm:hidden w-full mt-2 border-b border-black pb-2 sm:pb-0'>
                        <div className='w-full py-[3vw] pb-[1vw] sm:pb-0 flex items-center justify-between'>
                            ...
                            <i onClick={handleCompany} class="ri-add-circle-line text-[6vw]"></i>
                        </div>
                    ...
                    <div className='sm:hidden w-full mt-2 border-b border-black pb-2 sm:pb-0'>
                        <div className='w-full py-[3vw] pb-[1vw] sm:pb-0 flex items-center justify-between'>
                            ...
                            <i onClick={handleSupport} class="ri-add-circle-line text-[6vw]"></i>
                        </div>
                ...
                <div className='w-full mt-[10vw] sm:mt-[2vw] flex flex-col sm:flex-row justify-between items-center sm:items-end relative'>
                    <div className="social  flex gap-[5vw] sm:gap-[1vw]">
                        <i class="hover:text-black/50 text-[12vw] sm:text-[2.3vw] duration-300 cursor-pointer ri-facebook-circle-fill"></i>
                        <i class="hover:text-black/50 text-[12vw] sm:text-[2.3vw] duration-300 cursor-pointer ri-instagram-fill"></i>
                        <i class="hover:text-black/50 text-[12vw] sm:text-[2.3vw] duration-300 cursor-pointer ri-twitter-fill"></i>
                        <i class="hover:text-black/50 text-[12vw] sm:text-[2.3vw] duration-300 cursor-pointer ri-youtube-fill"></i>
                    </div>
